...
//       <button 
//       type="submit" 
//       className="w-full h-10 bg-[#3ecf4c] text-white rounded-lg font-sans font-bold text-base tracking-wider mb-10">Masuk</button>
//     )
//   }
// }
...
//     <button 
//       type="submit" 
//       className="w-full h-10 bg-[#e2fcd9] text-[#3ecf4c] rounded-lg font-sans font-bold text-base tracking-wider mb-10">Daftar</button>
//   )
// }

// const ButtonGoogle = () => {
//   return (
//     <button className="flex items-center justify-center gap-2 border-solid border-[#f1f1f1] border-2 text-[#4a505c] font-bold" >
//       <svg
//               width="21"
//               height="21"
//               viewBox="0 0 21 21"
